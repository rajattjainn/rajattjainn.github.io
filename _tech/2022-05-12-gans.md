...
The building blocks of a generator are transpose convolutional layer(s), leaky ReLU activations, and [Batch Norm](2022-05-12-batch_norm.md) layers.

### The Loss Function
The Loss expression for a GAN is given below. This merely says to find a G that minimizes the cost function and to find a D that maximises the cost function.
